...
class TestPlatformBasics:
    ...
    async def test_server_initialization_cross_platform(self):
        ...
        print(f"✓ Server initialization successful on {platform_info['system']} {platform_info['machine']}")
...
class TestEnvironmentCompatibility:
    ...
    async def test_python_version_compatibility(self):
        ...
        print(f"✓ Compatible with Python {platform_info['python_version']} ({platform_info['python_implementation']})")
